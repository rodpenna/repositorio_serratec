...
public class EmpresaDAO {
	...
	public boolean existeEmpresaID(int idEmpresa) {
		ResultSet tabela;
		boolean retorno;
							
		//MONTAGEM DE SQL
		String sql = "select * from marketplace.empresa where idEmpresa = '" + idEmpresa +"'";
	...
	public boolean existeEmpresaRazaoSocial(String razaoSocial) {
		ResultSet tabela;
		boolean retorno;
							
		//MONTAGEM DE SQL
		String sql = "select * from marketplace.empresa where razaosocial = '" + razaoSocial +"'";
