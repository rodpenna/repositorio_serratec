...
public class ProdutoDAO {
	...
	public boolean existeProdutoID(int idProduto) {
		ResultSet tabela;
		boolean retorno;
							
		//MONTAGEM DE SQL
		String sql = "select * from marketplace.produto where idProduto = '" + idProduto +"'";
	...
	public boolean existeProdutoNome(String nomeProduto) {
		ResultSet tabela;
		boolean retorno;
							
		//MONTAGEM DE SQL
		String sql = "select * from marketplace.produto where nomeproduto = '" + nomeProduto +"'";
